...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  scene("game", (choosenPlayer) => {
    ...
    let player = choosenPlayer == 1 ? add([
      sprite("Danya"),
      "player",
      scale(0.2),
      pos(80, 40),
    ...
    __name(produceCoins, "produceCoins");
    ...
    __name(produceSkeleton, "produceSkeleton");
    ...
    __name(produceTrain, "produceTrain");
    loop(1.5, () => {
    ...
    onCollide("player", "score", (player2, coin) => {
      score += 10;
      scoreText.text = score;
      play("score");
      coin.destroy();
    });
    onCollide("player", "skeleton", (player2, skeleton) => {
      let boom = add([
        sprite("boom"),
        pos(150, height() - 120),
        area(),
    ...
    onCollide("player", "train", (player2, train) => {
      player2.destroy();
      train.destroy();
      if (choosenPlayer == 1) {
        add([
